  ...
  useEffect(() => {
    const fetchExchangeRates = async () => {
      try {
        ...
        const rates = data[0].rates.reduce((acc: ExchangeRates, rate: { code: string; mid: number }) => {
    ...
    <Card className="w-full max-w-lg mx-auto mb-6 ml-0 overflow-hidden">
      ...
      <CardContent className="grid gap-4">
        <div className="grid grid-cols-[1fr_auto_auto_1fr] gap-2">
          <Input type="number" value={amount} onChange={handleAmountChange} className="rounded-r-none min-w-[80px]" />
